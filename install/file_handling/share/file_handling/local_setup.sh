...
: ${AMENT_CURRENT_PREFIX:="/home/user/fprobocon/install/file_handling"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/file_handling/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/file_handling/environment/path.sh"
